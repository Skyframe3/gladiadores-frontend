...
let ROUTES=[
 {id:1,name:"Senderos y Cascada",tag:"POPULAR",exp:"panoramica",img:"img/rutas/senderos-y-cascada/foto-1-s.avif",gal:1,galeria:["img/rutas/senderos-y-cascada/foto-1-s.avif"],diff:"MODERADA",dur:"3 hrs",dist:"45 km",desc:"Recorrido 4x4 por parque ecoturístico, mirador y cascada. Perfecta para contemplar y vivir el off road al mismo tiempo.",terrain:["Mirador","Cascada","Bosque"],horarios:["10:00","15:00"],
   units:[
     ...
     {id:"maverick-2",name:"Maverick X3 RS",type:"SSV 2 plazas",seats:2,booked:[],tarifas:[{personas:2,precio:4000}]},
     {id:"maverick-4",name:"Maverick X3",type:"SSV 4 plazas",seats:4,booked:[],tarifas:[{personas:2,precio:4000},{personas:3,precio:4800},{personas:4,precio:5600}]}]},
 {id:2,name:"Ruta Gran Mirador",tag:"EXTREMA",exp:"extrema",img:"img/i5.avif",gal:8,diff:"AVANZADA",dur:"3 hrs",dist:"80 km",desc:"La ruta más extrema. El mejor mirador de la Sierra Norte. Bosque, rocas y subidas que ponen a prueba todo.",terrain:["Mirador","Rocas","Extremo"],horarios:["09:00","12:00"],
   units:[
     ...
     {id:"maverick-2",name:"Maverick X3 RS",type:"SSV 2 plazas",seats:2,booked:[],tarifas:[{personas:2,precio:4800}]},
     {id:"maverick-4",name:"Maverick X3",type:"SSV 4 plazas",seats:4,booked:[],tarifas:[{personas:2,precio:4800},{personas:3,precio:5300},{personas:4,precio:5800}]}]},
 {id:3,name:"Ruta del Río",tag:"AVENTURA",exp:"panoramica",img:"img/rutas/ruta-del-rio/foto-1-s.avif",gal:12,galeria:["img/rutas/ruta-del-rio/foto-1-s.avif","img/rutas/ruta-del-rio/foto-2-s.avif","img/rutas/ruta-del-rio/foto-3-s.avif","img/rutas/ruta-del-rio/foto-4-s.avif","img/rutas/ruta-del-rio/foto-5-s.avif","img/rutas/ruta-del-rio/foto-6-s.avif","img/rutas/ruta-del-rio/foto-7-s.avif","img/rutas/ruta-del-rio/foto-8-s.avif","img/rutas/ruta-del-rio/foto-9-s.avif","img/rutas/ruta-del-rio/foto-10-s.avif","img/rutas/ruta-del-rio/foto-11-s.avif","img/rutas/ruta-del-rio/foto-12-s.avif"],diff:"MODERADA",dur:"1 hr",dist:"50 km",desc:"Primera experiencia perfecta. Muchos cruces de río, bosque abundante y ambiente familiar. Ideal para todos.",terrain:["Río","Bosque","Familiar"],horarios:["10:00","12:00","14:00","16:00"],
   units:[
     ...
     {id:"maverick-2",name:"Maverick X3 RS",type:"SSV 2 plazas",seats:2,booked:[],tarifas:[{personas:2,precio:3100}]},
     {id:"maverick-4",name:"Maverick X3",type:"SSV 4 plazas",seats:4,booked:[],tarifas:[{personas:2,precio:3100},{personas:3,precio:3600},{personas:4,precio:4100}]}]},
 {id:4,name:"La Ruta Clásica",tag:"FAMILIAR",exp:"panoramica",img:"img/rutas/la-ruta-clasica/foto-1-s.avif",gal:9,galeria:["img/rutas/la-ruta-clasica/foto-1-s.avif","img/rutas/la-ruta-clasica/foto-2-s.avif","img/rutas/la-ruta-clasica/foto-3-s.avif","img/rutas/la-ruta-clasica/foto-4-s.avif","img/rutas/la-ruta-clasica/foto-5-s.avif","img/rutas/la-ruta-clasica/foto-6-s.avif","img/rutas/la-ruta-clasica/foto-7-s.avif","img/rutas/la-ruta-clasica/foto-8-s.avif","img/rutas/la-ruta-clasica/foto-9-s.avif"],diff:"MODERADA",dur:"1.5 hrs",dist:"38 km",desc:"La ruta que siempre recomendarán. Cueva, fábrica abandonada, río y senderos. Clásica por algo.",terrain:["Clásica","Cueva","Río"],horarios:["10:00","12:00","14:00","16:00"],
   units:[
     ...
     {id:"maverick-2",name:"Maverick X3 RS",type:"SSV 2 plazas",seats:2,booked:[],tarifas:[{personas:2,precio:3300}]},
     {id:"maverick-4",name:"Maverick X3",type:"SSV 4 plazas",seats:4,booked:[],tarifas:[{personas:2,precio:3300},{personas:3,precio:3800},{personas:4,precio:4300}]}]},
 {id:5,name:"Aventura Nocturna",tag:"ESPECIAL",exp:"extrema",img:"img/rutas/aventura-nocturna/foto-1-s.avif",gal:6,galeria:["img/rutas/aventura-nocturna/foto-1-s.avif","img/rutas/aventura-nocturna/foto-2-s.avif","img/rutas/aventura-nocturna/foto-3-s.avif","img/rutas/aventura-nocturna/foto-4-s.avif","img/rutas/aventura-nocturna/foto-5-s.avif","img/rutas/aventura-nocturna/foto-6-s.avif"],diff:"MODERADA",dur:"1 hr 50 min",dist:"35 km",desc:"El bosque de noche es otro mundo. Recorrido nocturno con el cielo estrellado como techo y la adrenalina multiplicada.",terrain:["Nocturno","Bosque","Estrellas"],horarios:["18:00"],
   units:[
     ...
     {id:"maverick-2",name:"Maverick X3 RS",type:"SSV 2 plazas",seats:2,booked:[],tarifas:[{personas:2,precio:3700}]},
     {id:"maverick-4",name:"Maverick X3",type:"SSV 4 plazas",seats:4,booked:[],tarifas:[{personas:2,precio:3700},{personas:3,precio:4200},{personas:4,precio:4700}]}]},
 {id:6,name:"Luciérnagas",tag:"TEMPORADA",exp:"panoramica",img:"img/rutas/luciernagas/foto-1-s.avif",gal:1,galeria:["img/rutas/luciernagas/foto-1-s.avif"],diff:"MODERADA",dur:"3+ hrs",dist:"25 km",desc:"Una de las experiencias más mágicas de México. Temporada limitada: el bosque se ilumina con miles de luciérnagas.",terrain:["Luciérnagas","Bosque","Temporada"],horarios:["18:00"],
   units:[
     ...
     {id:"maverick-2",name:"Maverick X3 RS",type:"SSV 2 plazas",seats:2,booked:[],tarifas:[{personas:2,precio:4300}]},
     {id:"maverick-4",name:"Maverick X3",type:"SSV 4 plazas",seats:4,booked:[],tarifas:[{personas:2,precio:4300},{personas:3,precio:4800},{personas:4,precio:5400}]}]},
 {id:7,name:"Amanecer en la Montaña",tag:"AVENTURA",exp:"panoramica",img:"img/rutas/amanecer-en-la-montana/foto-1-s.avif",gal:11,galeria:["img/rutas/amanecer-en-la-montana/foto-1-s.avif","img/rutas/amanecer-en-la-montana/foto-2-s.avif","img/rutas/amanecer-en-la-montana/foto-3-s.avif","img/rutas/amanecer-en-la-montana/foto-4-s.avif","img/rutas/amanecer-en-la-montana/foto-5-s.avif","img/rutas/amanecer-en-la-montana/foto-6-s.avif","img/rutas/amanecer-en-la-montana/foto-7-s.avif","img/rutas/amanecer-en-la-montana/foto-8-s.avif","img/rutas/amanecer-en-la-montana/foto-9-s.avif","img/rutas/amanecer-en-la-montana/foto-10-s.avif","img/rutas/amanecer-en-la-montana/foto-11-s.avif"],diff:"AVANZADA",dur:"3+ hrs",dist:"55 km",desc:"Sal antes del alba. Llega al mirador justo cuando el sol rompe el horizonte sobre la Sierra Norte. Imposible de olvidar.",terrain:["Amanecer","Montaña","Paisaje"],horarios:["05:30"],
   units:[
     ...
     {id:"maverick-2",name:"Maverick X3 RS",type:"SSV 2 plazas",seats:2,booked:[],tarifas:[{personas:2,precio:5100}]},
     {id:"maverick-4",name:"Maverick X3",type:"SSV 4 plazas",seats:4,booked:[],tarifas:[{personas:2,precio:5100},{personas:3,precio:5300},{personas:4,precio:5800}]}]},
 {id:8,name:"Experiencia Mezcal",tag:"CULTURAL",exp:"panoramica",img:"img/rutas/experiencia-mezcal/foto-1-s.avif",gal:1,galeria:["img/rutas/experiencia-mezcal/foto-1-s.avif"],diff:"MODERADA",dur:"2.5 hrs",dist:"42 km",desc:"Off road y cultura local. Recorre senderos hasta conocer el proceso artesanal del mezcal de la Sierra Norte de Puebla.",terrain:["Mezcal","Cultura","Senderos"],horarios:["11:00","15:00"],
   units:[
     ...
     {id:"maverick-2",name:"Maverick X3 RS",type:"SSV 2 plazas",seats:2,booked:[],tarifas:[{personas:2,precio:3800}]},
     {id:"maverick-4",name:"Maverick X3",type:"SSV 4 plazas",seats:4,booked:[],tarifas:[{personas:2,precio:3800},{personas:3,precio:4600},{personas:4,precio:5300}]}]},
 {id:9,name:"Expedición al Volcán",tag:"ÉPICA",exp:"extrema",img:"img/rutas/expedicion-al-volcan/foto-1-s.avif",gal:7,galeria:["img/rutas/expedicion-al-volcan/foto-1-s.avif","img/rutas/expedicion-al-volcan/foto-2-s.avif","img/rutas/expedicion-al-volcan/foto-3-s.avif","img/rutas/expedicion-al-volcan/foto-4-s.avif","img/rutas/expedicion-al-volcan/foto-5-s.avif","img/rutas/expedicion-al-volcan/foto-6-s.avif","img/rutas/expedicion-al-volcan/foto-7-s.avif"],diff:"AVANZADA",dur:"2 hrs",dist:"60 km",desc:"El volcán más cercano a Chignahuapan. Off road de alto nivel con vistas que no tienen comparación en toda la Sierra Norte.",terrain:["Volcán","Paisaje","Extremo"],horarios:["10:00","15:00"],
   units:[]},
 {id:10,name:"Cascada Iluminada",tag:"NOCTURNA",exp:"extrema",img:"img/i5.avif",gal:5,diff:"MODERADA",dur:"3 hrs",dist:"45 km",desc:"Parque iluminado, cascada y experiencia 4x4 nocturna. Principalmente viernes, sábado, domingo y fechas especiales.",terrain:["Nocturno","Cascada","Iluminación"],horarios:["18:00"],
   units:[
     ...
     {id:"maverick-2",name:"Maverick X3 RS",type:"SSV 2 plazas",seats:2,booked:[],tarifas:[{personas:2,precio:4200}]},
     {id:"maverick-4",name:"Maverick X3",type:"SSV 4 plazas",seats:4,booked:[],tarifas:[{personas:2,precio:4200},{personas:3,precio:5200},{personas:4,precio:5900}]}]}
];
...
const UNITS_FLEET=[
 ...
 {uid:"maverick-4",img:"img/unidades/maverick-x3-max-4p.avif",cat:"SSV MÁXIMO RENDIMIENTO",name:"Maverick X3",seats:"4 plazas",tag:"Potencia para cuatro",
 ...
 {uid:"maverick-2",img:"img/unidades/maverick-x3-rs-2p.avif",cat:"SSV BIPLAZA",name:"Maverick X3 RS",seats:"2 plazas",tag:"Adrenalina pura",
...
function goSlide(i){slides[cur].classList.remove('active');dots[cur].classList.remove('active');cur=(i+total)%total;slides[cur].classList.add('active');dots[cur].classList.add('active');const bg=slides[cur].querySelector('.slide-bg');if(bg.dataset.bg){bg.style.backgroundImage=`url(${bg.dataset.bg})`;bg.removeAttribute('data-bg');}bg.style.animation='none';void bg.offsetWidth;bg.style.animation='';clearInterval(timer);timer=setInterval(()=>goSlide(cur+1),6000);}
...
// INIT
// Los slides 2, 3 y 4 no se ven al abrir, pero su foto se descargaba igual:
// 226 KB compitiendo con lo que sí está en pantalla. Se piden cuando el
// navegador ya terminó lo urgente.
function cargarFondosDiferidos(){
